...
def test_different_keys_produce_different_ciphertext() -> None:
    ...
    type_a: DeterministicEncryptedString = DeterministicEncryptedString(key=b"key-a-32-chars-min-length-random")
    type_b: DeterministicEncryptedString = DeterministicEncryptedString(key=b"key-b-32-chars-min-length-random")
...
def test_roundtrip_various_emails(
    enc_type: DeterministicEncryptedString, email: str
) -> None:
